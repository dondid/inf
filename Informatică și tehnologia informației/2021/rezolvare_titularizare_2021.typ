...
Codul C++ și Pascal de rezolvare a adăugării alternante.
*(Codul este identic cu cel prezentat mai sus în Secțiunea I.1).*

=== 2. Algoritm eficient: Intervale disjuncte
Codul C++ și Pascal de rezolvare a ISMP (vezi Secțiunea I.2).
*(Codul este identic cu cel prezentat mai sus).*
